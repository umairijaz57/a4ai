  ...
  return (
    <div className="relative">
      ...
      >
        ...
        Empowering future-ready minds through ethical and hands-on STEM learning.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto text-center space-y-6">
          ...
          <p className="text-gray-700 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            We inspire K-12 students to explore AI and emerging technologies with curiosity, creativity, and responsibility.
          </p>
        </div>
      </section>
