...
export const cyberTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    image: "/parents/8.jpg",
    text: "The tools helped us a lot. They made it easy to understand numbers and make good choices. I think everyone should try them"
  },
  {
    id: 3,
    name: "Muhammad Zaviyan",
    image: "/parents/7.jpg",
    text: "The camp was so much fun! I made my own robot, solved puzzles, and learned how to be safe on the internet. I loved everything about it."
  },
];
