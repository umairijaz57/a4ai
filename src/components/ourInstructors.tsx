...
import { ourInstructorsJson } from "@/constant/ourInstructorsJson";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 pb-16">
          {ourInstructorsJson.map((member, index) => (
              ...
              >
                ...
                <div className="flex-shrink-0">
                  <div className="relative">
                    ...
                    {/* Decorative element */}
                    <div
                      className={`absolute -z-10 w-80 h-80 rounded-2xl ${
                        index % 2 === 0 ? "bg-blue-600" : "bg-blue-800"
                      } ${
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p className="text-lg text-blue-800 leading-relaxed max-w-2xl mb-6">
                    {member.description}
                  </p>
